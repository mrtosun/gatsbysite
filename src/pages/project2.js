    ...
    <div class="main-right">
      <div class="right-scrollable">
        ...
        <p>
          ...
          design that would differentiate their brand in the international
          market. As an industrial designer at TOBB ETU MEDEC, I’ve undertaken
          all off the product design stages from concept development to
          prototyping under the supervision of Dr. Aydın Öztoprak. I believe
        ...
        <p>
          ...
          following the FAA regulations and usability requirements. In
          cooperation with the client, a modular design was decided upon. In a
          modular design, different light types to could be integrated in
        ...
        <h3>Prototyping</h3>
        <p>
          One exciting part of this project was that I handled the prototyping
          on my own. I’ve prepared the CAM files and the NC code. It was my
          first experience with controlling a CNC router. The main body is
          machined out of delrin in CNC and the light module was made with a 3D
          printer.
        </p>
        <figure>
          <img
        ...
        <p>
          Designs were rendered in Keyshot to communicate the final look. Later
          on the client produced the final prototypes using in-house facilities.
        </p>
        <figure>
