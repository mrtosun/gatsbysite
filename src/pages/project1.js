  ...
  <div class="main">
    ...
    <div class="main-right">
      <div class="right-scrollable">
        ...
        <h3>The Game</h3>
        <p>
          Wildwatch revolves around the theme of birdwatching. It’s about
          creating a calm and relaxing experience without giving up on the
          challange and fun. It’s a game in which you encounter real animal
          species and appreciate the nature. In this game you complete
          objectives while leaving everything as you find it.
        </p>
        <figure>
          <div class="gif-png">
        ...
        <p>
          ...
          aware of their surroundings and they fly away if they spot you. So,
          you must move in stealth and manage to get close enough to take a
          picture.
        </p>
        <figure>
          <img
        ...
        <p>
          Not all the birds are the same, some of them are common and some of
          them are rare. Some are easy to spot and some of them are hard. They
          have different sight distance and radius. I’ve choosen some local bird
          species with varying properties by from the{" "}
          <Link to="#">Birds of METU guide book</Link>.
        </p>
        <h3>Game Mechanics</h3>
        <p>
          The main game mechanic is based on stealth and heavily inspired by
          games like Commandos and Shadow Tactics. Each bird has two vision
          cones representing their binocular vision. These cones rotate as birds
          turn their heads. Objects like trees and large rocks block their
          vision. It’s players job to move without getting noticed and get close
          enough to a bird to capture a photo. Timing and positioning is key for
          a good shot.
        </p>
        <figure>
          <img
        ...
        <h3>Assets</h3>
        <p>
          I hand drew all the assets to populate the environment. It was quite
          fun to experiment with various brushes, textures and colors. My aim
          was to create a warm atmosphere while adopting a illustration style
          rather than realism. This style allows quick production and allows for
          more expressiveness.
        </p>
        <img
          src={assets}
